...
app.post("/create", validateToken, userController.createUser.bind(userController));
app.put("/update/:id", validateToken, userController.updateUser.bind(userController));
app.delete("/delete/:id", validateToken, userController.deleteUser.bind(userController));
