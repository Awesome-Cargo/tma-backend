...
export class ReportController {
  ...
  async getAvailableFields(_req: Request, res: Response) {
    try {
  ...
  async getAllReports(_req: Request, res: Response) {
    try {
  ...
  async updateReport(req: Request, res: Response) {
    ...
    try {
      ...
      // const aux = updatedReport?.sheets[0] as unknown as { fields: string[] };
